...
export default function Form({ handleSubmit, setFile, loading }) {
  ...
  return (
    <div className="rounded-md flex flex-col items-center gap-6 w-full h-[28vh] px-4 lg:w-[30%] lg:h-full ">
      {loading && <Loader />}
      <div className="flex flex-col items-center justify-evenly bg-white border-custom2 shadow-lg rounded-md h-full p-1 border-2 w-[80%] sm:w-[50%] lg:h-[40%] lg:p-4 lg:border-4 lg:w-full lg:gap-4">
        ...
        >
          ...
          <label
            htmlFor="image"
            className="bg-gradient-to-r from-sky-500 to-indigo-500 text-white rounded-md flex justify-center items-center active:scale-90 duration-200 w-[70%] py-1 text-lg sm:w-[60%] lg:w-[60%] lg:py-2 lg:text-xl"
          >
      ...
      <div className="w-full h-[60%] flex-col items-center justify-evenly border-4 border-custom2 shadow-lg bg-white rounded-md p-4 hidden lg:flex">
